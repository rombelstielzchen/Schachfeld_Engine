...
bool CTestMoveMaker::test_algebraic_game() {
    ...
    board.set_fen_position("startpos moves g1f3 d7d5 g2g3 c7c6 f1g2 g8f6 e1g1 e7e6 a2a4 f8e7 a4a5 b7b5 a5b6 e8g8 b6b7 b8d7 b7a8q");
    // TODO: test textual moves and underpromotions, they fail
    CTEST << "Move-history: " <<board.move_maker.move_history.size() << "\n";
    ...
    EXPECT(board.get_square(FILE_A, RANK_8) == WHITE_QUEEN);
