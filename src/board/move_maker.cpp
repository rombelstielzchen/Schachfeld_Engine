...
void CMoveMaker::make_move(SMove move) {
    ...
    switch (move.move_type) {
        ...
        case MOVE_TYPE_ENG_PASSENG:
            assert((moving_piece == WHITE_POWER) || (moving_piece == BLACK_POWER));
...
std::string CMoveMaker::moves_from_initial_position() const {
    std::string result = "";
