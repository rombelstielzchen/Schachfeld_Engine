...
constexpr int32_t SCORE_VILLAINS_KING_CAPTUREVILLAINS_KING_CAPTUREDD = SCORE_HERO_WINS - 1000;
static_assert(SCORE_VILLAINS_KING_CAPTUREVILLAINS_KING_CAPTUREDD > 0);
