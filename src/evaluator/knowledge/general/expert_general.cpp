...
//   * center is mostly not so good, except sometimes d4 (d5 for black)
...
TPieceSquareValueTable psv_white_queen = {{
    ...
    { 0,   0, 100, 100, 102, 100, 100, 100,  70, 100 },
    { 0,   0, 100, 104,  90, 100, 100, 100, 100, 100 },
    { 0,   0, 101, 100, 100, 107, 102, 100, 100, 100 },
