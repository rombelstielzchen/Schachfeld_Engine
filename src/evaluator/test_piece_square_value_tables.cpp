...
bool CTestPieceSquareValueTables::test_positions() {
    ...
    EXPECT(CTestEvaluator::first_position_better("B w", "/ w"));
    EXPECT(CTestEvaluator::first_position_better("/ w", "b w"));
    // Reasonable relation between different pieces
    EXPECT(CTestEvaluator::first_position_better("3K w", "3Q  w"));
    EXPECT(CTestEvaluator::first_position_better("3Q w", "3R w"));
    EXPECT(CTestEvaluator::first_position_better("3R w", "3B w"));
    EXPECT(CTestEvaluator::first_position_better("3B w", "3N w"));
    EXPECT(CTestEvaluator::first_position_better("3N w", "/P w"));
    EXPECT(CTestEvaluator::first_position_better("/P w", "/p w"));
    EXPECT(CTestEvaluator::first_position_better("/p w", "3n w"));
    EXPECT(CTestEvaluator::first_position_better("3n w", "3b w"));
    EXPECT(CTestEvaluator::first_position_better("3b w", "3r w"));
