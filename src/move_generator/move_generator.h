...
class CMoveGenerator {
  ...
  private:
    ...
    void generate_king_moves(const SSquare source);
    void generate_castlings(const SSquare source);
    void generate_knight_moves(const SSquare source);
    void generate_bishop_moves(const SSquare source);
    void generate_rook_moves(const SSquare source);
    void generate_queen_moves(const SSquare source);
  private:
    void generate_potential_move(const SSquare source, const TFile target_file, const TRank target_rank);
    void generate_sliding_moves(const SSquare source, const int direction_north_south, const int direction_east_west);
