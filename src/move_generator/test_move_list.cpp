...
bool CTestMoveList::test_king_capture() {
   ...
   EXPECT(board.set_fen_position(black_king_can_be_captured));
   move_generator.generate_all();
    EXPECT(move_generator.move_list.king_capture_on_list() == true);
    std::string const white_king_can_be_captured = "Krk b";
    move_generator.move_list.clear();
    move_generator.generate_all();
   EXPECT(board.set_fen_position(white_king_can_be_captured));
    EXPECT(move_generator.move_list.king_capture_on_list() == true);
    std::string const white_king_only_in_check = "Krk w";
   EXPECT(board.set_fen_position(white_king_only_in_check));
    move_generator.move_list.clear();
    move_generator.generate_all();
