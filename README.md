TattooAngel -- Chess Engine
===========================

TattooAngelis a chess-engine, developed by some members of the Schachfeld-forum. Meant to become semi-strong and fun to play one day. Currently in the early stages of its development.
...
How To Download
---------------
[version_1.0.zip](https://github.com/rombelstielzchen/Schachfeld_Engine/raw/refs/heads/main/release/archives/tattooangel_chess_engine_1.0.zip) (Windows, 64 Bit)
...
* Open the file "src/Visual_Studio/TattooAngel.sln".
* Click Menu -> Build -> Rebuild All.
* The command-line program "TattooAngel.exe" should now exist in the folder "src/visual_studio/x64/Release", ready to be used.
...
TattooAngel will then run user-friendly in a black window
...
License
-------
TattooAngel is licensed as open-source under GPLv3. This basically means that you are allowed to do whatever you want, as long as you distribute any derived work under the same noble conditions.
